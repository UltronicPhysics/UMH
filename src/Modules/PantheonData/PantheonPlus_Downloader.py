...
def get_default_config(config_overrides=None):
    ...
    return {
        ...
        #2022 + corrections 
        "PANTHEON_DATA_URL": "https://raw.githubusercontent.com/PantheonPlusSH0ES/DataRelease/refs/heads/main/Pantheon%2B_Data/4_DISTANCES_AND_COVAR/Pantheon%2BSH0ES.dat",
        "PANTHEON_DATA_FILENAME": "PantheonPlus_SH0ES.dat",

        "PANTHEON_DATA_BIAS_URL": "https://raw.githubusercontent.com/PantheonPlusSH0ES/DataRelease/refs/heads/main/Pantheon%2B_Data/4_DISTANCES_AND_COVAR/Pantheon%2BSH0ES_STAT%2BSYS.cov",
        "PANTHEON_DATA_BIAS_FILENAME": "PantheonPlus_SH0ES_STAT_SYS.cov",

        #https://raw.githubusercontent.com/PantheonPlusSH0ES/DataRelease/refs/heads/main/Pantheon%2B_Data/4_DISTANCES_AND_COVAR/Pantheon%2BSH0ES_STATONLY.cov
...
def run_pantheon_data_download(config_overrides=None):
    ...
    PANTHEON_DATA_BIAS_URL=config["PANTHEON_DATA_BIAS_URL"]
    PANTHEON_DATA_BIAS_FILENAME=config["PANTHEON_DATA_BIAS_FILENAME"]
    ...
    file_bias_out=os.path.join(outdir, PANTHEON_DATA_BIAS_FILENAME)
    ...
    try:
        ...
        print(f"✅ {title}: Downloading data from {PANTHEON_DATA_BIAS_URL}...")
        response = requests.get(PANTHEON_DATA_BIAS_URL)
        response.raise_for_status()  # Raises an error for bad status codes
