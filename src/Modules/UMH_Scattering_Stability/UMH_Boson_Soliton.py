"""
UMH_Scattering_Stability_Boson.py

Author: Andrew Dodge
Date: June 2025

Description:
UMH Scattering Stability Boson.
...
def boson_soliton_test(config_overrides=None):
    ...
    title="UMH Scattering Stability (Boson)"
    file_root="UMH_Scattering_Stability"
    file_sub="UMH_Boson_Soliton"
    file_hdr="UMH_Scattering_Stability_Boson"
    ...
    create_soliton(lattice, center=center2, radius=8, amplitude=1.0, phase=0.0)
    ...
    for step in range(steps):
        ...
        if step % 10 == 0:
            ...
            #normt_smooth=gaussian_filter(normt, sigma=3.0)
            # Use center Z-slice
            ...
            #slice_ctr = center_crop(slice_2d, crop_size=128)
            ...
            plt.imshow(zoom_slice_smooth, cmap='plasma', origin='lower',interpolation='nearest',vmin=global_min, vmax=global_max) #zoom_slice vmin=global_min, vmax=global_max
